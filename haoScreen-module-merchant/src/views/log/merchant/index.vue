<template>
  <el-container class="log-merchant-wrapper common-container">
    <el-main class="log-merchant-content common-body">
      <el-row>
...
import { getMerchantLog } from '@/api/log'
...
export default {
  ...
  methods: {
    ...
    // request
    async _getMerchantLog() {
      this.isLoading = true
      const param = { ...this.pages, ...this.searchForm }
      delete param.total
      await getMerchantLog(param).then(res => {
        if (res.code === 200) {
